...
public static class AttributeAccessorExtensions
{
    ...
    /// <summary>
    /// Get specific <typeparamref name="TAttribute"/> from <paramref name="type"/>.
    /// </summary>
    ...
    /// <summary>
    /// Retrieves a read-only collection of <see cref="Attribute"/> from <paramref name="type"/>.
    /// </summary>
    /// <param name="type"></param>
    /// <typeparam name="TAttribute"></typeparam>
    /// <returns></returns>
    ...
    {
        return Attribute.GetCustomAttributes(type).AsReadOnly();
    }
}
